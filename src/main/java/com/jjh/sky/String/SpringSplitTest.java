...
public class SpringSplitTest {
    ...
    public static void main (String[] args) {
        ...
        System.out.println(Splitter.onPattern("32").omitEmptyStrings().split(test1).toString());
        ...
        String mailAddress = "ludos_pizza@yeah.net";
        String regex = "^[A-Za-z0-9]+([-_.][A-Za-z0-9]+)*@([A-Za-z0-9])+((\\.|-)[A-Za-z0-9]+)*\\.[A-Za-z]{2,5}$";
